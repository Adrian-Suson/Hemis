...
const Navbar = () => {
    ...
    // ------------------------------------------------------------
    // Update editUser state when user changes
    // ------------------------------------------------------------
    useEffect(() => {
        if (user) {
            setEditUser({
    ...
    >
        ...
        {!user ? (
            ...
            <Box sx={{ p: 0 }}>
                ...
                <Box sx={{ p: 3 }}>
                    <List sx={{ width: '100%' }}>
                        <ListItem sx={{ px: 0, py: 1.5, borderBottom: `1px solid ${theme.palette.divider}` }}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <TextField
                            ...
                            fullWidth
                            variant="outlined"
                            error={editUser.confirmPassword !== "" && editUser.password !== editUser.confirmPassword}
                            helperText={
