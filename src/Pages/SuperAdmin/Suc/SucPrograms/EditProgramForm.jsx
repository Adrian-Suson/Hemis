...
function EditProgramForm({ isOpen, onClose, onSave, programData, loading = false }) {
    ...
    useEffect(() => {
        if (programData) {
            setFormData({
                ...
                program_code: programData.program_code ? programData.program_code.toString() : '',
                major_name: programData.major_name || '',
                major_code: programData.major_code ? programData.major_code.toString() : '',
                aop_category: programData.aop_category || '',
                aop_serial: programData.aop_serial || '',
                aop_year: programData.aop_year ? programData.aop_year.toString() : '',
                is_thesis_dissertation_required: programData.is_thesis_dissertation_required || false,
                program_status: programData.program_status || 'ACTIVE',
                calendar_use_code: programData.calendar_use_code || 'SEM',
                program_normal_length_in_years: programData.program_normal_length_in_years ? programData.program_normal_length_in_years.toString() : '',
                lab_units: programData.lab_units ? programData.lab_units.toString() : '',
                lecture_units: programData.lecture_units ? programData.lecture_units.toString() : '',
                total_units: programData.total_units ? programData.total_units.toString() : '',
                tuition_per_unit: programData.tuition_per_unit ? programData.tuition_per_unit.toString() : '',
                program_fee: programData.program_fee ? programData.program_fee.toString() : '',
                program_type: programData.program_type || 'undergraduate',
                new_students_freshmen_male: programData.new_students_freshmen_male ? programData.new_students_freshmen_male.toString() : '',
                new_students_freshmen_female: programData.new_students_freshmen_female ? programData.new_students_freshmen_female.toString() : '',
                '1st_year_male': programData['1st_year_male'] ? programData['1st_year_male'].toString() : '',
                '1st_year_female': programData['1st_year_female'] ? programData['1st_year_female'].toString() : '',
                '2nd_year_male': programData['2nd_year_male'] ? programData['2nd_year_male'].toString() : '',
                '2nd_year_female': programData['2nd_year_female'] ? programData['2nd_year_female'].toString() : '',
                '3rd_year_male': programData['3rd_year_male'] ? programData['3rd_year_male'].toString() : '',
                '3rd_year_female': programData['3rd_year_female'] ? programData['3rd_year_female'].toString() : '',
                '4th_year_male': programData['4th_year_male'] ? programData['4th_year_male'].toString() : '',
                '4th_year_female': programData['4th_year_female'] ? programData['4th_year_female'].toString() : '',
                '5th_year_male': programData['5th_year_male'] ? programData['5th_year_male'].toString() : '',
                '5th_year_female': programData['5th_year_female'] ? programData['5th_year_female'].toString() : '',
                '6th_year_male': programData['6th_year_male'] ? programData['6th_year_male'].toString() : '',
                '6th_year_female': programData['6th_year_female'] ? programData['6th_year_female'].toString() : '',
                '7th_year_male': programData['7th_year_male'] ? programData['7th_year_male'].toString() : '',
                '7th_year_female': programData['7th_year_female'] ? programData['7th_year_female'].toString() : '',
                subtotal_male: programData.subtotal_male ? programData.subtotal_male.toString() : '',
                subtotal_female: programData.subtotal_female ? programData.subtotal_female.toString() : '',
                grand_total: programData.grand_total ? programData.grand_total.toString() : '',
                lecture_units_actual: programData.lecture_units_actual ? programData.lecture_units_actual.toString() : '',
                laboratory_units_actual: programData.laboratory_units_actual ? programData.laboratory_units_actual.toString() : '',
                total_units_actual: programData.total_units_actual ? programData.total_units_actual.toString() : '',
                graduates_males: programData.graduates_males ? programData.graduates_males.toString() : '',
                graduates_females: programData.graduates_females ? programData.graduates_females.toString() : '',
                graduates_total: programData.graduates_total ? programData.graduates_total.toString() : '',
                externally_funded_merit_scholars: programData.externally_funded_merit_scholars ? programData.externally_funded_merit_scholars.toString() : '',
                internally_funded_grantees: programData.internally_funded_grantees ? programData.internally_funded_grantees.toString() : '',
                funded_grantees: programData.funded_grantees ? programData.funded_grantees.toString() : '',
                report_year: programData.report_year ? programData.report_year.toString() : new Date().getFullYear().toString(),
            });
        }
    }, [programData]);
    ...
    const handleInputChange = (field, value) => {
        ...
        if (field === 'lecture_units' || field === 'lab_units') {
            const lectureUnits = field === 'lecture_units' ? parseFloat(value) || 0 : parseFloat(formData.lecture_units) || 0;
            const labUnits = field === 'lab_units' ? parseFloat(value) || 0 : parseFloat(formData.lab_units) || 0;
            setFormData(prev => ({
                ...prev,
                [field]: value,
        ...
        if (field === 'graduates_males' || field === 'graduates_females') {
            const males = field === 'graduates_males' ? parseInt(value) || 0 : parseInt(formData.graduates_males) || 0;
            const females = field === 'graduates_females' ? parseInt(value) || 0 : parseInt(formData.graduates_females) || 0;
            setFormData(prev => ({
                ...prev,
                [field]: value,
    ...
    const calculateTotals = (data) => {
        const maleFields = [
            '1st_year_male', '2nd_year_male', '3rd_year_male', '4th_year_male',
            '5th_year_male', '6th_year_male', '7th_year_male'
        ];
        const femaleFields = [
            '1st_year_female', '2nd_year_female', '3rd_year_female', '4th_year_female',
            '5th_year_female', '6th_year_female', '7th_year_female'
        ];

        const totalMale = maleFields.reduce((sum, field) => sum + (parseInt(data[field]) || 0), 0);
        const totalFemale = femaleFields.reduce((sum, field) => sum + (parseInt(data[field]) || 0), 0);
    ...
    const validateForm = () => {
        ...
        // Numeric validations
        if (formData.program_normal_length_in_years && (isNaN(formData.program_normal_length_in_years) || formData.program_normal_length_in_years < 1 || formData.program_normal_length_in_years > 10)) {
            newErrors.program_normal_length_in_years = "Program length must be between 1 and 10 years";
        }

        // Unit validations
        if (formData.lab_units && (isNaN(formData.lab_units) || formData.lab_units < 0)) {
            newErrors.lab_units = "Lab units must be a positive number";
        }
        if (formData.lecture_units && (isNaN(formData.lecture_units) || formData.lecture_units < 0)) {
            newErrors.lecture_units = "Lecture units must be a positive number";
        }

        // Financial validations
        if (formData.tuition_per_unit && (isNaN(formData.tuition_per_unit) || formData.tuition_per_unit < 0)) {
            newErrors.tuition_per_unit = "Tuition per unit must be a positive number";
        }
        if (formData.program_fee && (isNaN(formData.program_fee) || formData.program_fee < 0)) {
    ...
    const handleSubmit = () => {
        if (validateForm()) {
            const updatedProgramData = {
                ...formData,
                id: programData.id,
                suc_details_id: parseInt(formData.suc_details_id),
            ...
            <div className="space-y-4 max-h-[600px] overflow-y-auto p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleInputChange("major_code", e.target.value)}
                                placeholder="e.g., 201"
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                            />
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100 rounded-xl p-4 border border-emerald-200/60 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AOP Category</label>
                                    <select
                                        value={formData.aop_category}
                                        onChange={(e) => handleInputChange("aop_category", e.target.value)}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AOP Serial</label>
                                    <input
                                        type="text"
                                        value={formData.aop_serial}
                                        onChange={(e) => handleInputChange("aop_serial", e.target.value)}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AOP Year</label>
                                    <input
                                        type="number"
                                        value={formData.aop_year}
                                        onChange={(e) => handleInputChange("aop_year", e.target.value)}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange("program_normal_length_in_years", e.target.value)}
                                        placeholder="e.g., 4"
                                        min="1"
                                        max="10"
                                        className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200 ${
                                            errors.program_normal_length_in_years ? "border-red-300 bg-red-50" : "border-gray-300"
                                        }`}
                                    />
                                    {errors.program_normal_length_in_years && <p className="text-red-500 text-xs mt-1">{errors.program_normal_length_in_years}</p>}
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => handleInputChange("calendar_use_code", e.target.value)}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200"
                                    >
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    checked={formData.is_thesis_dissertation_required}
                                    onChange={(e) => handleInputChange("is_thesis_dissertation_required", e.target.checked)}
                                    className="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300 rounded"
                                />
                                <label htmlFor="thesis_required_edit" className="ml-2 text-sm text-gray-700">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-100 rounded-xl p-4 border border-purple-200/60 shadow-sm">
                        <div className="flex items-center space-x-3 mb-3">
                            ...
                            <h3 className="text-base font-semibold text-gray-900">Units & Finances</h3>
                        </div>
                        <div className="space-y-3">
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div>
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange("lecture_units", e.target.value)}
                                            placeholder="Lecture"
                                            min="0"
                                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 ${
                                                errors.lecture_units ? "border-red-300 bg-red-50" : "border-gray-300"
                                            }`}
                                        />
                                        <label className="text-xs text-gray-600">Lecture Units</label>
                                        {errors.lecture_units && <p className="text-red-500 text-xs mt-1">{errors.lecture_units}</p>}
                                    </div>
                                    <div>
                                        <input
                                            type="number"
                                            value={formData.lab_units}
                                            onChange={(e) => handleInputChange("lab_units", e.target.value)}
                                            placeholder="Lab"
                                            min="0"
                                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 ${
                                                errors.lab_units ? "border-red-300 bg-red-50" : "border-gray-300"
                                            }`}
                                        />
                                        <label className="text-xs text-gray-600">Lab Units</label>
                                        {errors.lab_units && <p className="text-red-500 text-xs mt-1">{errors.lab_units}</p>}
                                    </div>
                                    <div>
                                        <input
                                            type="number"
                                            ...
                                            readOnly
                                        />
                                        <label className="text-xs text-purple-600">Total Units</label>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleInputChange("tuition_per_unit", e.target.value)}
                                    placeholder="e.g., 500.00"
                                    min="0"
                                    step="0.01"
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 ${
                                        errors.tuition_per_unit ? "border-red-300 bg-red-50" : "border-gray-300"
                                    }`}
                                />
                                {errors.tuition_per_unit && <p className="text-red-500 text-xs mt-1">{errors.tuition_per_unit}</p>}
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Program Fee (₱)</label>
                                <input
                                    type="number"
                                    value={formData.program_fee}
                                    onChange={(e) => handleInputChange("program_fee", e.target.value)}
                                    placeholder="e.g., 5000.00"
                                    min="0"
                                    step="0.01"
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 ${
                                        errors.program_fee ? "border-red-300 bg-red-50" : "border-gray-300"
                                    }`}
                                />
                                {errors.program_fee && <p className="text-red-500 text-xs mt-1">{errors.program_fee}</p>}
                            </div>
                            <div>
                ...
                <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100 rounded-xl p-4 border border-amber-200/60 shadow-sm">
                    <div className="flex items-center space-x-3 mb-3">
                        ...
                        <h3 className="text-base font-semibold text-gray-900">Enrollment Data</h3>
                    </div>
                    <div className="space-y-4">
                        {/* New Students */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">New Freshmen Students</label>
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <input
                                        type="number"
                                        value={formData.new_students_freshmen_male}
                                        onChange={(e) => handleInputChange("new_students_freshmen_male", e.target.value)}
                                    ...
                                    />
                                    <label className="text-xs text-gray-600">Male</label>
                                </div>
                                <div>
                                    <input
                                        type="number"
                                        value={formData.new_students_freshmen_female}
                                        onChange={(e) => handleInputChange("new_students_freshmen_female", e.target.value)}
                                        placeholder="Female freshmen"
                                        min="0"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200"
                                    />
                                    <label className="text-xs text-gray-600">Female</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Current Enrollment by Year Level</label>
                            <div className="space-y-2">
                                {[1, 2, 3, 4, 5, 6, 7].map((year) => (
                                    <div key={year} className="grid grid-cols-3 gap-2 items-center">
                                        <label className="text-sm text-gray-700 font-medium">
                                            {year === 1 ? '1st' : year === 2 ? '2nd' : year === 3 ? '3rd' : `${year}th`} Year
                                        </label>
                                        <input
                                            type="number"
                                            value={formData[`${year === 1 ? '1st' : year === 2 ? '2nd' : year === 3 ? '3rd' : `${year}th`}_year_male`]}
                                            onChange={(e) => handleInputChange(`${year === 1 ? '1st' : year === 2 ? '2nd' : year === 3 ? '3rd' : `${year}th`}_year_male`, e.target.value)}
                                            placeholder="Male"
                                            min="0"
                                        ...
                                        <input
                                            type="number"
                                            value={formData[`${year === 1 ? '1st' : year === 2 ? '2nd' : year === 3 ? '3rd' : `${year}th`}_year_female`]}
                                            onChange={(e) => handleInputChange(`${year === 1 ? '1st' : year === 2 ? '2nd' : year === 3 ? '3rd' : `${year}th`}_year_female`, e.target.value)}
                                            placeholder="Female"
                                            min="0"
                                            className="px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 text-sm"
                                        />
                        ...
                        <div className="bg-white/60 rounded-lg p-3 border border-amber-300">
                            <div className="grid grid-cols-3 gap-4 text-center">
                                <div>
                                    <div className="text-lg font-semibold text-blue-600">{formData.subtotal_male || 0}</div>
                                    <div className="text-xs text-gray-600">Total Male</div>
                                </div>
                                <div>
                                    <div className="text-lg font-semibold text-pink-600">{formData.subtotal_female || 0}</div>
                                    <div className="text-xs text-gray-600">Total Female</div>
                                </div>
                                <div>
                                    <div className="text-lg font-bold text-amber-900">{formData.grand_total || 0}</div>
                                    <div className="text-xs text-amber-600">Grand Total</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100 rounded-xl p-4 border border-slate-200/60 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Male Graduates</label>
                                    <input
                                        type="number"
                                        value={formData.graduates_males}
                                        onChange={(e) => handleInputChange("graduates_males", e.target.value)}
                                        placeholder="0"
                                        min="0"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Female Graduates</label>
                                    <input
                                        type="number"
                                        value={formData.graduates_females}
                                        onChange={(e) => handleInputChange("graduates_females", e.target.value)}
                                        placeholder="0"
                                        min="0"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-colors duration-200"
                                    />
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Total Graduates</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Actual Units Taken</label>
                                <div className="grid grid-cols-3 gap-2">
                                    <div>
                                        <input
                                            type="number"
                                            value={formData.lecture_units_actual}
                                            onChange={(e) => handleInputChange("lecture_units_actual", e.target.value)}
                                            placeholder="Lecture"
                                            min="0"
                                    ...
                                    <div>
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange("laboratory_units_actual", e.target.value)}
                                            placeholder="Lab"
                                            min="0"
                                            className="w-full px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-colors duration-200 text-sm"
                                        />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange("total_units_actual", e.target.value)}
                                            placeholder="Total"
                                            min="0"
                                            className="w-full px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-colors duration-200 text-sm"
                                        />
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-100 rounded-xl p-4 border border-indigo-200/60 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">External Merit Scholars</label>
                                <input
                                    type="number"
                                    value={formData.externally_funded_merit_scholars}
                                    onChange={(e) => handleInputChange("externally_funded_merit_scholars", e.target.value)}
                                    placeholder="0"
                                    min="0"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Internal Grantees</label>
                                <input
                                    type="number"
                                    value={formData.internally_funded_grantees}
                                    onChange={(e) => handleInputChange("internally_funded_grantees", e.target.value)}
                                    placeholder="0"
                                    min="0"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                                />
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Total Funded Students</label>
                                <input
                                    type="number"
                                    value={formData.funded_grantees}
                                    onChange={(e) => handleInputChange("funded_grantees", e.target.value)}
                                    placeholder="0"
                                    min="0"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                                />
