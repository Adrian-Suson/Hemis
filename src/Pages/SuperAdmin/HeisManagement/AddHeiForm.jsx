...
function AddHeiForm({ isOpen, onClose, onSave, loading, clusters, heis }) {
    ...
    return (
        <Dialog
            ...
            onClose={onClose}
            title="Add New HEI"
            subtitle="Enter the details of the new Higher Education Institution"
            icon={Building2}
            footer={footer}
            size="sm"
        >
...
AddHeiForm.propTypes = {
    ...
    heis: PropTypes.array.isRequired
};
