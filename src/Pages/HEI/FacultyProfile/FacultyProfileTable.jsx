                                ...
                                <tr className="bg-gray-50">
                                    {columnGroupingModel.map((group) => (
                                        <th
                                            ...
                                            className="px-2 py-1 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-200 bg-gray-50 sticky top-0 z-20"
                                        >
                                            {group.headerName}
                                        </th>
                                    ))}
                        ...
                        <thead className="bg-gray-50 sticky top-0 z-10">
                            <tr>
                                {currentColumns.map((column) => (
                                    <th
                                        key={column.field}
                                        className="px-2 py-1.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-r border-gray-200 truncate sticky top-0 bg-gray-50 z-10"
