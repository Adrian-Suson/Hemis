...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('curricular_programs', function (Blueprint $table) {
            ...
            $table->integer('first_year_old_male')->nullable();
            $table->integer('first_year_old_female')->nullable();
            $table->integer('second_year_male')->nullable();
            $table->integer('second_year_female')->nullable();
            $table->integer('third_year_male')->nullable();
            $table->integer('third_year_female')->nullable();
            $table->integer('fourth_year_male')->nullable();
            $table->integer('fourth_year_female')->nullable();
            $table->integer('fifth_year_male')->nullable();
            $table->integer('fifth_year_female')->nullable();
            $table->integer('sixth_year_male')->nullable();
            $table->integer('sixth_year_female')->nullable();
            $table->integer('seventh_year_male')->nullable();
            $table->integer('seventh_year_female')->nullable();
