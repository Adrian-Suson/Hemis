    ...
    public function run()
    {
        ...
        $municipalitiesByProvince = [
            'Basilan' => [
                ...
                ['name' => 'Isabela City', 'postal_code' => '7300'], // ICC
                ['name' => 'Lamitan City', 'postal_code' => '7302'], // Capital
                ...
                ['name' => 'Ungkaya Pukan', 'postal_code' => '7307'], // Total: 11 municipalities, 2 cities
            ],
            'Zamboanga del Norte' => [
                ['name' => 'Bacungan', 'postal_code' => '7117'],
                ['name' => 'Baliguian', 'postal_code' => '7123'],
                ['name' => 'Dapitan City', 'postal_code' => '7101'],
                ['name' => 'Dipolog City', 'postal_code' => '7100'], // Capital
                ...
                ['name' => 'Tampilisan', 'postal_code' => '7116'], // Total: 25 municipalities, 2 cities
            ],
            'Zamboanga del Sur' => [
                ...
                ['name' => 'Pagadian City', 'postal_code' => '7016'], // Capital
                ...
                ['name' => 'Zamboanga City', 'postal_code' => '7000'], // HUC
            ],
            'Zamboanga Sibugay' => [
                ...
                ['name' => 'Ipil', 'postal_code' => '7001'], // Capital
                ...
                ['name' => 'Tungawan', 'postal_code' => '7018'], // Total: 16 municipalities
            ],
            'Tawi-Tawi' => [
                ['name' => 'Bongao', 'postal_code' => '7500'], // Capital
            ...
            'Sulu' => [
                ...
                ['name' => 'Tapul', 'postal_code' => '7410'], // Total: 19 municipalities
            ],
        ];
