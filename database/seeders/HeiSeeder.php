...
class HeiSeeder extends Seeder
{
    ...
    {
        // First, get all clusters from the database
        ...
        $heis = [
            ...
            // Zamboanga del Norte HEIs (Cluster 2)
            ...
            ['uiid' => '9019', 'name' => 'Rizal Memorial Institute of Dapitan City, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Norte'],
            ['uiid' => '9047', 'name' => 'Dipolog City Institute of Technology', 'type' => 'Private', 'cluster' => 'Zamboanga del Norte'],
            ...
            // Zamboanga del Sur HEIs (Cluster 3)
            ...
            ['uiid' => '9043', 'name' => 'Pagadian Capitol College, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ...
            ['uiid' => '9062', 'name' => 'Universidad de Zamboanga - Ipil', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9065', 'name' => 'Medina College Ipil, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9068', 'name' => 'Philippine Technological and Marine Sciences', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9070', 'name' => 'Southern Peninsula College, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9071', 'name' => 'Lucan Central Colleges, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9072', 'name' => 'Sibugay Technical Institute Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9074', 'name' => 'Universidad de Zamboanga - Pagadian Branch Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9076', 'name' => 'Aim High Colleges, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9077', 'name' => 'Ave Maria College', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9079', 'name' => 'Hyrons College Philippines, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ...
            ['uiid' => '9099', 'name' => 'Zamboanga del Sur Provincial Government College - Pagadian', 'type' => 'LUC', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9102', 'name' => 'Emmaus College of Theology Foundation, Inc.', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ['uiid' => '9103', 'name' => 'Pagadian City International College', 'type' => 'Private', 'cluster' => 'Zamboanga del Sur'],
            ...
            // Basilan HEIs (Cluster 4)
            ['uiid' => '9003', 'name' => 'Basilan State College', 'type' => 'SUC', 'cluster' => 'Basilan'],
            ['uiid' => '15035', 'name' => 'Mindanao Autonomous College Foundation Inc. of Isabela City', 'type' => 'Private', 'cluster' => 'Basilan'],

            // Sulu HEIs (Cluster 5)
            ['uiid' => '15002', 'name' => 'Central Sulu College', 'type' => 'Private', 'cluster' => 'Sulu'],
            ['uiid' => '15003', 'name' => 'Hadji Butu School of Arts and Trades', 'type' => 'SUC', 'cluster' => 'Sulu'],
            ['uiid' => '15005', 'name' => 'Lapak Agricultural School', 'type' => 'SUC', 'cluster' => 'Sulu'],
            ['uiid' => '15007', 'name' => 'Mindanao State University - Sulu Development Technical College', 'type' => 'SUC', 'cluster' => 'Sulu'],
            ['uiid' => '15009', 'name' => 'Notre Dame Jolo College', 'type' => 'Private', 'cluster' => 'Sulu'],
            ['uiid' => '15013', 'name' => 'Sulu State College', 'type' => 'SUC', 'cluster' => 'Sulu'],
            ['uiid' => '15025', 'name' => 'Southwestern Mindanao Islamic Institute', 'type' => 'Private', 'cluster' => 'Sulu'],
            ['uiid' => '15065', 'name' => 'Sulu College of Technology, Inc.', 'type' => 'Private', 'cluster' => 'Sulu'],

            // Tawi-Tawi HEIs (Cluster 6)
            ['uiid' => '15008', 'name' => 'Mindanao State University - Tawi-Tawi College of Technology and Oceonography', 'type' => 'SUC', 'cluster' => 'Tawi-Tawi'],
            ['uiid' => '15014', 'name' => 'Tawi-Tawi Regional Agricultural College', 'type' => 'SUC', 'cluster' => 'Tawi-Tawi'],
        ];
